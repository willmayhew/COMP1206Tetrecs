...
public class GameWindow {
     ...
     * @param multimedia Current music player
     */
    public void startLobby(Multimedia multimedia){
        loadScene(new LobbyScene(this,multimedia));
    }
     ...
     * @param multimedia Current music player
     */
    public void startInstruction(Multimedia multimedia) {
        loadScene(new InstructionsScene(this,multimedia));
    }

    /**
     * Display the score screen
     * @param game Game which just completed
     */
    ...
    /**
     * Display the score screen for a multiplayer game
     * @param game Game which just completed
     * @param multiplayerList List of players in the multiplayer game
     */
    public void startScore(Game game, Leaderboard multiplayerList){
        loadScene(new ScoreScene(this,game, multiplayerList));
    }

    /**
     * Display the multiplayer screen for the multiplayer game
     * @param communicator Communicator for the current game
     * @param playerCount Number of players in the multiplayer game
     */
    public void startMultiplayer(Communicator communicator, int playerCount){
        loadScene(new MultiplayerScene(this,communicator,playerCount));
    }
